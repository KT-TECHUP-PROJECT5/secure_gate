...
| `runtime-validation` | Health Check / Smoke Test / Header / ZAP/Nuclei 결과 | D파트 연결 완료 |
...
| `scripts/runtime-validation.py` | Health / Smoke / Header / ZAP / Nuclei 결과를 `runtime-report.json`으로 생성 |
