...
| `runtime-validation` | Health Check / Smoke Test / Header / Custom Check / ZAP/Nuclei 결과 | D파트 기준 작성 완료 / A파트 연결 필요 |
...
| `post-deploy-validation` | 배포 후 Runtime Validation | D파트 기준 작성 완료 / A파트 연결 필요 |
...
| `scripts/runtime-validation.py` | Health / Smoke / Header / Custom Check / ZAP / Nuclei 결과를 `runtime-report.json`으로 생성 |
